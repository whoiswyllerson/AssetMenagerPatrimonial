...
export const PrintIcon: React.FC<IconProps> = ({ className = "w-5 h-5" }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M6.72 13.829c-.24.03-.48.062-.72.096m.72-.096a42.415 42.415 0 0 1 10.56 0m-10.56 0L6 18.25m0 0h12m-12 0a2.25 2.25 0 0 1-2.25-2.25v-2.25c0-1.02.622-1.91 1.52-2.213m12.238-3.328a2.25 2.25 0 0 0-1.52-2.213l-1.52-2.213-1.52 2.213A2.25 2.25 0 0 1 18 13.5v2.25a2.25 2.25 0 0 1-2.25 2.25m-12 0h12" />
    </svg>
);
...
export const ChevronDoubleLeftIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
